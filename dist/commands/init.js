...
async function createPluginFiles(dir, path) {
    ...
    const result = await downloadTemplate('https://raw.githubusercontent.com/pikachii/kintone-plugin-cli/main/templates/template.tar', { dir: resolve(imageDir) });
    console.log(result);
}
async function editManifestJson(dir, path) {
